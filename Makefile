...
ifeq ($(OS),Windows_NT)
    ...
    export MYPYPATH=src\\dcr;src\\dcr\\db;src\\dcr\\db\\orm;src\\dcr\\libs;src\\dcr\\PDFlib;src\\dcr\\pp
    export PYTHONPATH=src\\dcr;src\\dcr\\db;src\\dcr\\db\\orm;src\\dcr\\libs;src\\dcr\\PDFlib;src\\dcr\\pp
else
