...
| [sed for Windows](http://gnuwin32.sourceforge.net/packages/sed.htm){:target="_blank"}   | 4.2.1   | base version             |        |## Version 0.9.3
...
| [TeX Live](https://www.tug.org/texlive){:target="_blank"}    | 2019                   | base version                        | new     |
