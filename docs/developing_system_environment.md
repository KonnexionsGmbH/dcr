# DCR - Developing - System Environment
...
The GitHub actions for continuous integration run on **`Ubuntu 20.04`** and **`Ubuntu 22.04`**~~, **`Micrsoft Windows Server 2019`** and **`Micrsoft Windows Server 2022`**~~.
