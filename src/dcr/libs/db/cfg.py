...
# DBC_TOKEN_POS_IN_LINE: str = "token_pos_in_line"
# DBC_TOKEN_POS_IN_SENTENCE: str = "token_pos_in_sentence"
...
JSON_NAME_FONT_ID: str = "fontId"
JSON_NAME_FONT_SIZE: str = "fontSize"
JSON_NAME_ID: str = "id"
JSON_NAME_ITALIC_ANGLE: str = "italicAngle"
JSON_NAME_NAME: str = "name"
