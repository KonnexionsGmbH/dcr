...
class TextParser:
    ...
    # Class variables.
    # -----------------------------------------------------------------------------
    JSON_NAME_DOCUMENT_FILE_NAME: ClassVar[str] = "documentFileName"
    ...
    JSON_NAME_LINE_TEXT: ClassVar[str] = "lineText"
    JSON_NAME_LINE_TYPE: ClassVar[str] = "lineType"
    JSON_NAME_NO_PAGES_IN_DOC: ClassVar[str] = "noPagesInDoc"
    JSON_NAME_PAGES: ClassVar[str] = "pages"
    JSON_NAME_PAGE_NO: ClassVar[str] = "pageNo"

    _JSON_NAME_LINE_INDEX_PARA: ClassVar[str] = "lineIndexPara"
    _JSON_NAME_NO_LINES_IN_PAGE: ClassVar[str] = "noLinesInPage"
    _JSON_NAME_NO_PARAS_IN_PAGE: ClassVar[str] = "noParasInPage"
    _JSON_NAME_PAGE_TEXT: ClassVar[str] = "pageText"
    _JSON_NAME_PARA_INDEX_PAGE: ClassVar[str] = "paraIndexPage"
    _JSON_NAME_WORDS: ClassVar[str] = "words"
    _JSON_NAME_WORD_INDEX_LINE: ClassVar[str] = "wordIndexLine"
    _JSON_NAME_WORD_TEXT: ClassVar[str] = "wordText"

    _PARSE_NAME_SPACE: ClassVar[str] = "{http://www.pdflib.com/XML/TET5/TET-5.0}"

    _PARSE_TAG_ACTION: ClassVar[str] = "Action"
    _PARSE_TAG_ANNOTATIONS: ClassVar[str] = "Annotations"
    _PARSE_TAG_ATTACHMENTS: ClassVar[str] = "Attachments"
    _PARSE_TAG_AUTHOR: ClassVar[str] = "Author"
    _PARSE_TAG_BOOKMARKS: ClassVar[str] = "Bookmarks"
    _PARSE_TAG_BOX: ClassVar[str] = "Box"
    _PARSE_TAG_CELL: ClassVar[str] = "Cell"
    _PARSE_TAG_CONTENT: ClassVar[str] = "Content"
    _PARSE_TAG_CREATION_DATE: ClassVar[str] = "CreationDate"
    _PARSE_TAG_CREATOR: ClassVar[str] = "Creator"
    _PARSE_TAG_CUSTOM: ClassVar[str] = "Custom"
    _PARSE_TAG_DESTINATIONS: ClassVar[str] = "Destinations"
    _PARSE_TAG_DOC_INFO: ClassVar[str] = "DocInfo"
    _PARSE_TAG_ENCRYPTION: ClassVar[str] = "Encryption"
    _PARSE_TAG_EXCEPTION: ClassVar[str] = "Exception"
    _PARSE_TAG_FIELDS: ClassVar[str] = "Fields"
    _PARSE_TAG_GRAPHICS: ClassVar[str] = "Graphics"
    _PARSE_TAG_JAVA_SCRIPTS: ClassVar[str] = "JavaScripts"
    _PARSE_TAG_LINE: ClassVar[str] = "Line"
    _PARSE_TAG_METADATA: ClassVar[str] = "Metadata"
    _PARSE_TAG_MOD_DATE: ClassVar[str] = "ModDate"
    _PARSE_TAG_OPTIONS: ClassVar[str] = "Options"
    _PARSE_TAG_OUTPUT_INTENTS: ClassVar[str] = "OutputIntents"
    _PARSE_TAG_PAGE: ClassVar[str] = "Page"
    _PARSE_TAG_PAGES: ClassVar[str] = "Pages"
    _PARSE_TAG_PARA: ClassVar[str] = "Para"
    _PARSE_TAG_PLACED_IMAGE: ClassVar[str] = "PlacedImage"
    _PARSE_TAG_PRODUCER: ClassVar[str] = "Producer"
    _PARSE_TAG_RESOURCES: ClassVar[str] = "Resources"
    _PARSE_TAG_ROW: ClassVar[str] = "Row"
    _PARSE_TAG_SIGNATURE_FIELDS: ClassVar[str] = "SignatureFields"
    _PARSE_TAG_TABLE: ClassVar[str] = "Table"
    _PARSE_TAG_TEXT: ClassVar[str] = "Text"
    _PARSE_TAG_TITLE: ClassVar[str] = "Title"
    _PARSE_TAG_WORD: ClassVar[str] = "Word"
    _PARSE_TAG_XFA: ClassVar[str] = "XFA"

    PARSE_TAG_CREATION: ClassVar[str] = "Creation"
    PARSE_TAG_DOCUMENT: ClassVar[str] = "Document"
    PARSE_TAG_FROM: ClassVar[int] = len(_PARSE_NAME_SPACE)
