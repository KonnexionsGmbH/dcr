...
class Setup:
    ...
    _DCR_CFG_SECTION_ENV_TEST: typing.ClassVar[str] = "dcr.env.test"
    _DCR_CFG_SECTION_SPACY: typing.ClassVar[str] = "dcr.spacy"
    _DCR_CFG_SIMULATE_PARSER: typing.ClassVar[str] = "simulate_parser"

    _DCR_CFG_SPACY_TKN_ATTR_CLUSTER: typing.ClassVar[str] = "spacy_tkn_attr_cluster"
    _DCR_CFG_SPACY_TKN_ATTR_DEP_: typing.ClassVar[str] = "spacy_tkn_attr_dep_"
    _DCR_CFG_SPACY_TKN_ATTR_DOC: typing.ClassVar[str] = "spacy_tkn_attr_doc"
    ...
    _DCR_CFG_SPACY_TKN_ATTR_HEAD: typing.ClassVar[str] = "spacy_tkn_attr_head"
    _DCR_CFG_SPACY_TKN_ATTR_I: typing.ClassVar[str] = "spacy_tkn_attr_i"
    _DCR_CFG_SPACY_TKN_ATTR_IDX: typing.ClassVar[str] = "spacy_tkn_attr_idx"
    _DCR_CFG_SPACY_TKN_ATTR_IS_ALPHA: typing.ClassVar[str] = "spacy_tkn_attr_is_alpha"
    _DCR_CFG_SPACY_TKN_ATTR_IS_ASCII: typing.ClassVar[str] = "spacy_tkn_attr_is_ascii"
    _DCR_CFG_SPACY_TKN_ATTR_IS_BRACKET: typing.ClassVar[str] = "spacy_tkn_attr_is_bracket"
    ...
    _DCR_CFG_SPACY_TKN_ATTR_IS_LEFT_PUNCT: typing.ClassVar[str] = "spacy_tkn_attr_is_left_punct"
    _DCR_CFG_SPACY_TKN_ATTR_IS_LOWER: typing.ClassVar[str] = "spacy_tkn_attr_is_lower"
    ...
    _DCR_CFG_SPACY_TKN_ATTR_IS_QUOTE: typing.ClassVar[str] = "spacy_tkn_attr_is_quote"
    _DCR_CFG_SPACY_TKN_ATTR_IS_RIGHT_PUNCT: typing.ClassVar[str] = "spacy_tkn_attr_is_right_punct"
    ...
    _DCR_CFG_SPACY_TKN_ATTR_IS_SPACE: typing.ClassVar[str] = "spacy_tkn_attr_is_space"
    ...
    _DCR_CFG_SPACY_TKN_ATTR_IS_UPPER: typing.ClassVar[str] = "spacy_tkn_attr_is_upper"
    ...
    _DCR_CFG_SPACY_TKN_ATTR_LEX: typing.ClassVar[str] = "spacy_tkn_attr_lex"
    _DCR_CFG_SPACY_TKN_ATTR_LEX_ID: typing.ClassVar[str] = "spacy_tkn_attr_lex_id"
    ...
    _DCR_CFG_SPACY_TKN_ATTR_LOWER_: typing.ClassVar[str] = "spacy_tkn_attr_lower_"
    _DCR_CFG_SPACY_TKN_ATTR_MORPH: typing.ClassVar[str] = "spacy_tkn_attr_morph"
    _DCR_CFG_SPACY_TKN_ATTR_NORM_: typing.ClassVar[str] = "spacy_tkn_attr_norm_"
    _DCR_CFG_SPACY_TKN_ATTR_ORTH_: typing.ClassVar[str] = "spacy_tkn_attr_orth_"
    _DCR_CFG_SPACY_TKN_ATTR_POS_: typing.ClassVar[str] = "spacy_tkn_attr_pos_"
    _DCR_CFG_SPACY_TKN_ATTR_PREFIX_: typing.ClassVar[str] = "spacy_tkn_attr_prefix_"
    _DCR_CFG_SPACY_TKN_ATTR_PROB: typing.ClassVar[str] = "spacy_tkn_attr_prob"
    _DCR_CFG_SPACY_TKN_ATTR_RANK: typing.ClassVar[str] = "spacy_tkn_attr_rank"
    _DCR_CFG_SPACY_TKN_ATTR_RIGHT_EDGE: typing.ClassVar[str] = "spacy_tkn_attr_right_edge"
    _DCR_CFG_SPACY_TKN_ATTR_SENT: typing.ClassVar[str] = "spacy_tkn_attr_sent"
    _DCR_CFG_SPACY_TKN_ATTR_SENTIMENT: typing.ClassVar[str] = "spacy_tkn_attr_sentiment"
    _DCR_CFG_SPACY_TKN_ATTR_SHAPE_: typing.ClassVar[str] = "spacy_tkn_attr_shape_"
    _DCR_CFG_SPACY_TKN_ATTR_SUFFIX_: typing.ClassVar[str] = "spacy_tkn_attr_suffix_"
    _DCR_CFG_SPACY_TKN_ATTR_TAG_: typing.ClassVar[str] = "spacy_tkn_attr_tag_"
    _DCR_CFG_SPACY_TKN_ATTR_TENSOR: typing.ClassVar[str] = "spacy_tkn_attr_tensor"
    ...
    _DCR_CFG_SPACY_TKN_ATTR_VOCAB: typing.ClassVar[str] = "spacy_tkn_attr_vocab"
