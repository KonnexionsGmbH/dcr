...
class TokenizerSpacy:
    ...
    def _finish_document(self) -> None:
        ...
        json_data = {
            ...
            dcr_core.nlp.cls_nlp_core.NLPCore.JSON_NAME_NO_LINES_FOOTER: self._no_lines_footer,
            dcr_core.nlp.cls_nlp_core.NLPCore.JSON_NAME_NO_LINES_HEADER: self._no_lines_header,
            dcr_core.nlp.cls_nlp_core.NLPCore.JSON_NAME_NO_LINES_IN_DOC: self._no_lines_in_doc,
            dcr_core.nlp.cls_nlp_core.NLPCore.JSON_NAME_NO_LINES_TOC: self._no_lines_toc,
        ...
        if dcr_core.cfg.glob.setup.is_tokenize_2_jsonfile:
            with open(self._file_name_next, "w", encoding=dcr_core.cfg.glob.FILE_ENCODING_DEFAULT) as file_handle:
                json.dump(
                    json_data,
                    file_handle,
    ...
    def _process_page(self) -> None:
        ...
        for dcr_core.cfg.glob.text_parser.parse_result_line_line in dcr_core.cfg.glob.text_parser.parse_result_line_page[
            ...
            if (
                ...
                and dcr_core.cfg.glob.setup.is_spacy_ignore_line_type_footer
                or line_type == dcr_core.nlp.cls_nlp_core.NLPCore.LINE_TYPE_HEADER
                and dcr_core.cfg.glob.setup.is_spacy_ignore_line_type_header
                or line_type == dcr_core.nlp.cls_nlp_core.NLPCore.LINE_TYPE_HEADING
                and dcr_core.cfg.glob.setup.is_spacy_ignore_line_type_heading
                or line_type == dcr_core.nlp.cls_nlp_core.NLPCore.LINE_TYPE_LIST_BULLET
                and dcr_core.cfg.glob.setup.is_spacy_ignore_line_type_list_bullet
                or line_type == dcr_core.nlp.cls_nlp_core.NLPCore.LINE_TYPE_LIST_NUMBER
                and dcr_core.cfg.glob.setup.is_spacy_ignore_line_type_list_number
                or line_type == dcr_core.nlp.cls_nlp_core.NLPCore.LINE_TYPE_TABLE
                and dcr_core.cfg.glob.setup.is_spacy_ignore_line_type_table
                or line_type == dcr_core.nlp.cls_nlp_core.NLPCore.LINE_TYPE_TOC
                and dcr_core.cfg.glob.setup.is_spacy_ignore_line_type_toc
            ):
                continue
