...
"""Testing Module libs.preprocessor.inbox."""
import os.path
...
def test_run_action_process_inbox_accepted_duplicate(fxtr_setup_empty_db_and_inbox):
    ...
    pytest.helpers.copy_files_4_pytest_2_dir([(stem_name_1, file_ext)], libs.cfg.directory_inbox_accepted)
...
def test_run_action_process_inbox_rejected_duplicate(fxtr_setup_empty_db_and_inbox):
    ...
    pytest.helpers.copy_files_4_pytest_2_dir([(stem_name_1, file_ext)], libs.cfg.directory_inbox_rejected)
