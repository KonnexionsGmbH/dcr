...
from libs.cfg import RUN_ACTION_ALL_COMPLETE
from libs.cfg import RUN_ACTION_PROCESS_INBOX
...
def test_main_all(fxtr_new_db_empty_inbox):
    ...
    main([DCR_ARGV_0, RUN_ACTION_ALL_COMPLETE])


def test_main_p_i_no_db(fxtr_no_db):
    """Test: ACTION_PROCESS_INBOX - DB missing."""
    with pytest.raises(SystemExit) as expt:
        main([DCR_ARGV_0, RUN_ACTION_PROCESS_INBOX])
